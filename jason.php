...
//    $input = fgets(STDIN);
 ...
 //     echo 'is null';
    ...
    //echo "Reply : $reply"."<br>";
        ...
        $myObj->long = $satellite[1];
        $myObj->lat = $satellite[2];
        $myObj->az = $satellite[3];
        $myObj->el = $satellite[4];
        $myObj->aollos = $satellite[5];
        $myObj->footprint = $satellite[6];
        $myObj->range = $satellite[7];
        $myObj->altitude = $satellite[8];
        $myObj->velocity = $satellite[9];
        $myObj->orbitnr = $satellite[10];
        $myObj->visibility = $satellite[11];
        $myObj->orbitalphase = $satellite[12];
        $myObj->eclipsephase = $satellite[13];
        $myObj->squint = $satellite[14];
